    ...
    var n = function() {
        var n = {
          ...
          , p = function(s) {
            ...
            return o.onHandleTouch.call(t) === !1 ? this : (t.length > 0 && t.is(":hidden") && (n.one("click.superfish", !1),
          ...
          , f = function() {
            var s = e(this)
              , n = m(s);
            o ? e.proxy(d, s, n)() : (clearTimeout(n.sfTimer),
            n.sfTimer = setTimeout(e.proxy(d, s, n), n.delay))
        }
          , d = function(s) {
        ...
        return {
            ...
            destroy: function() {
                return this.each(function() {
                    ...
                    return t ? (s = o.find(t.popUpSelector).parent("li"),
