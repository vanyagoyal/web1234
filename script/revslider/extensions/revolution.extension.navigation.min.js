...
!function(t) {
    ...
    jQuery.extend(!0, e, {
        hideUnHideNav: function(t) {
            ...
            p(s) && T(t.c.parent().find(".tp-tabs"), s.hide_under, e, s.hide_over),
            y(t)
        },
        resizeThumbsTabs: function(t, e) {
            if (t.navigation && t.navigation.tabs.enable || t.navigation && t.navigation.thumbnails.enable) {
                ...
                if (a.pause(),
                i = i > 1 ? 1 : 0 > i ? 0 : i,
                p(s) && (e || s.width > s.min_width) && n(i, a, t.c, s, t.slideamount, "tab"),
                p(r) && (e || r.width > r.min_width) && n(i, a, t.c, r, t.slideamount, "thumb"),
                p(o) && e) {
        ...
        createNavigation: function(t, e) {
            ...
            t.bind("revolution.slide.onafterswap revolution.nextslide.waiting", function() {
                ...
                n.find(".tp-thumb, .tp-tab").each(function() {
                    ...
                    t.hasClass("tp-tab") ? a(n.find(".tp-tabs"), v) : a(n.find(".tp-thumbs"), u)) : t.removeClass("selected")
                });
                var r = 0
                  , o = !1;
                ...
                if (s.enable === !0) {
                    ...
                    s.right.j.html(h),
                    punchgs.TweenLite.set(s.left.j.find(".tp-arr-imgholder"), {
    ...
    var a = function(t, e) {
        ...
        t.hasClass("tp-thumbs") ? ".tp-thumb-mask" : ".tp-tab-mask")
          ...
          , v = r.data("offset");
        p > 2 && (f = 0 >= c - (v + d) ? 0 - d > c - (v + d) ? v : f + d : f,
        f = d > c - d + v + l && c + (Math.round(p) - 2) * d < v ? c + (Math.round(p) - 2) * d : f),
        f = 0 - (g - u) > f ? 0 - (g - u) : f > 0 ? 0 : f,
        "vertical" !== o && s.width() >= r.width() && (f = 0),
        "vertical" === o && s.height() >= r.height() && (f = 0),
        t.hasClass("dragged") || ("vertical" === o ? r.data("tmmove", punchgs.TweenLite.to(r, .5, {
            top: f + "px",
      ...
      , s = function(t) {
        ...
        (a || n) && t.deltaMode && (1 == t.deltaMode ? (a *= r,
        n *= r) : (a *= o,
        n *= o)),
        a && !e && (e = 1 > a ? -1 : 1),
        n && !i && (i = 1 > n ? -1 : 1),
        ...
        if ("on" === i.navigation.mouseScrollNavigation || "carousel" === i.navigation.mouseScrollNavigation) {
            ...
            t.on("mousewheel DOMMouseScroll", function(r) {
                var o = s(r.originalEvent)
                  ...
                  , u = !0;
                return "carousel" == i.navigation.mouseScrollNavigation && (h = p = !1),
                ...
                i.sc_indicator_dir = 1,
                e.callingNewSlide(i, t, 1),
                u = !1)) : u = !p && o.spinY > 0 || !h && o.spinY <= 0 ? !1 : !0,
                0 == u ? (r.preventDefault(r),
                !1) : void 0
            })
        }
    }
      ...
      , l = function(t, a, n) {
        ...
        r.swipetp({
            ...
            swipeStatus: function(i, n, r, o, h, p, u) {
                ...
                if ("carousel" === a.sliderType && (("move" === n || "end" === n || "cancel" == n) && a.dragStartedOverSlider && !a.dragStartedOverThumbs && !a.dragStartedOverTabs || "start" === n && c > 0 && 0 === g && 0 === f))
                    switch (a.dragStartedOverSlider = !0,
                    o = r && r.match(/left|up/g) ? Math.round(-1 * o) : o = Math.round(1 * o),
                    n) {
                    case "start":
                        void 0 !== s.positionanim && (s.positionanim.kill(),
                        s.slide_globaloffset = "off" === s.infinity ? s.slide_offset : e.simp(s.slide_offset, s.maxwidth)),
                        s.overpull = "none",
                        s.wrap.addClass("dragged");
                        break;
                    case "move":
                        if (s.slide_offset = "off" === s.infinity ? s.slide_globaloffset + o : e.simp(s.slide_globaloffset + o, s.maxwidth),
                        "off" === s.infinity) {
                            ...
                            "none" !== s.overpull && 0 !== s.overpull || !(0 > b || b > a.slideamount - 1) ? b >= 0 && b <= a.slideamount - 1 && (b >= 0 && o > s.overpull || b <= a.slideamount - 1 && o < s.overpull) && (s.overpull = 0) : s.overpull = o,
                            s.slide_offset = 0 > b ? s.slide_offset + (s.overpull - o) / 1.1 + Math.sqrt(Math.abs((s.overpull - o) / 1.1)) : b > a.slideamount - 1 ? s.slide_offset + (s.overpull - o) / 1.1 - Math.sqrt(Math.abs((s.overpull - o) / 1.1)) : s.slide_offset
                        }
                    ...
                    if (("move" !== n && "end" !== n && "cancel" != n || a.dragStartedOverSlider || !a.dragStartedOverThumbs && !a.dragStartedOverTabs) && !("start" === n && c > 0 && (g > 0 || f > 0))) {
                        if ("end" == n && !m) {
                            ...
                            "horizontal" == l && "left" == r || "vertical" == l && "up" == r)
                                return a.sc_indicator_dir = 0,
                                e.callingNewSlide(a, a.c, 1),
                                !1;
                            if ("horizontal" == l && "right" == r || "vertical" == l && "down" == r)
                    ...
                    case "start":
                        ...
                        O = "vertical" === S ? L.position().top : L.position().left,
                        L.data("offset", O),
                    ...
                    case "move":
                        if (I >= C)
                            return !1;
                        Q = O + o,
                        Q = Q > 0 ? "horizontal" === S ? Q - L.width() * (Q / L.width() * Q / L.width()) : Q - L.height() * (Q / L.height() * Q / L.height()) : Q;
                        var M = "vertical" === S ? 0 - (L.height() - j.height()) : 0 - (L.width() - j.width());
                        Q = M > Q ? "horizontal" === S ? Q + L.width() * (Q - M) / L.width() * (Q - M) / L.width() : Q + L.height() * (Q - M) / L.height() * (Q - M) / L.height() : Q,
                        "vertical" === S ? punchgs.TweenLite.set(L, {
                            top: Q + "px"
                    ...
                    case "cancel":
                        if (m)
                            return Q = O + o,
                            Q = "vertical" === S ? Q < 0 - (L.height() - j.height()) ? 0 - (L.height() - j.height()) : Q : Q < 0 - (L.width() - j.width()) ? 0 - (L.width() - j.width()) : Q,
                            Q = Q > 0 ? 0 : Q,
                            Q = Math.abs(o) > k / 10 ? 0 >= o ? Math.floor(Q / k) * k : Math.ceil(Q / k) * k : 0 > o ? Math.ceil(Q / k) * k : Math.floor(Q / k) * k,
                            Q = "vertical" === S ? Q < 0 - (L.height() - j.height()) ? 0 - (L.height() - j.height()) : Q : Q < 0 - (L.width() - j.width()) ? 0 - (L.width() - j.width()) : Q,
                            Q = Q > 0 ? 0 : Q,
                            "vertical" === S ? punchgs.TweenLite.to(L, .5, {
                                top: Q + "px",
                            ...
                            Q = Q ? Q : "vertical" === S ? L.position().top : L.position().left,
                            L.data("offset", Q),
                            L.data("distance", o),
                            setTimeout(function() {
                                a.dragStartedOverSlider = !1,
