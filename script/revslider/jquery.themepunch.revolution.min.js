...
!function(e, t) {
    ...
    e.extend(!0, i, {
        ...
        enterInViewPort: function(a) {
            a.waitForCountDown && (M(a.c, a),
            a.waitForCountDown = !1),
            a.waitForFirstSlide && (H(a.c, a),
    ...
    var a = i.is_mobile()
      ...
      , s = function(a, n) {
        ...
        ("carousel" == a.sliderType || "on" == s.keyboardNavigation || "on" == s.mouseScrollNavigation || "on" == s.touch.touchenabled || s.arrows.enable || s.bullets.enable || s.thumbnails.enable || s.tabs.enable) && (o.navigation = !0),
        n.find(".tp-caption, .tp-static-layer, .rs-background-video-layer").each(function() {
            var i = e(this);
        ...
        n.find("li").each(function() {
            e(this).data("link") && e(this).data("link") != t && (o.layeranim = !0,
            o.actions = !0)
        }),
        !o.videos && (n.find(".rs-background-video-layer").length > 0 || n.find(".tp-videolayer").length > 0 || n.find("iframe").length > 0 || n.find("video").length > 0) && (o.videos = !0),
        "carousel" == a.sliderType && (o.carousel = !0),
        ("off" !== a.parallax.type || a.viewPort.enable || "true" == a.viewPort.enable) && (o.parallax = !0)) : (o.kenburns = !0,
        o.parallax = !0,
        o.carousel = !1,
        o.navigation = !0,
        o.videos = !0,
        ...
        o.layeranim = !0,
        o.migration = !0),
        "hero" == a.sliderType && (o.carousel = !1,
        o.navigation = !1),
        window.location.href.match(/file:/gi) && (o.filesystem = !0,
        a.filesystem = !0),
      ...
      , h = function(n, o) {
        ...
        !n.hasClass("revslider-initialised")) {
            ...
            o.li.each(function(t) {
                var i = e(this);
                ("all" == o.lazyType || "smart" == o.lazyType && (0 == t || 1 == t || t == o.slideamount || t == o.slideamount - 1)) && (S(i, o, t),
                z(i, o, function() {
            ...
            var O = o.viewPort;
            o.inviewport = !1,
            O != t && O.enable && (e.isNumeric(O.visible_area) || -1 !== O.visible_area.indexOf("%") && (O.visible_area = parseInt(O.visible_area) / 100),
            ...
            e(window).on(I, function() {
                return n == t ? !1 : (0 != e("body").find(n) && v(o),
      ...
      , w = function(n, o) {
        ...
        o.li.find(">img").each(function(i) {
            ...
            "on" == o.fallbacks.panZoomDisableOnMobile && a && (n.data("kenburns", "off"),
            n.data("bgfit", "cover")),
      ...
      , H = function(t, a) {
        ...
        o.data("slide_on_focus_amount", o.data("slide_on_focus_amount") + 1 || 1),
      ...
      , O = function(e, a, n) {
        ...
        i.scrollHandling && (i.scrollHandling(e, !0),
